const googleAdsCampaignsPageData = {
  ...
  heroImage: {
    src: "/services/ICON-CARDS-3.webp",
    alt: "Google Ads service visual",
  },
  video: {
  ...
  context: {
    ...
    leftBottomAlt: "Ads campaign visual two",
  },
  concept: {
    label: "MESSAGING",
    ...
    videos: [
      {
        ...
        fallbackSrc: "/ceativecontent/GIFanimation1.mp4",
        poster: "/creativeagency/advideo.webp",
        alt: "Ads triptych visual one",
      },
      {
        src: "/modernlifestyle/galleryv1.webm",
        fallbackSrc: "/modernlifestyle/designcase1.mp4",
        poster: "/modernlifestyle/mainbanner1.webp",
        alt: "Ads triptych visual two",
      },
      {
        src: "/ceativecontent/GIFanimation3.webm",
        fallbackSrc: "/ceativecontent/GIFanimation3.mp4",
