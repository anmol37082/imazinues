const productPhotographyVideographyPageData = {
  ...
  heroImage: {
    src: "/services/ICON-CARDS-8.webp",
    alt: "Product photography and videography service visual",
  },
  video: {
  ...
  context: {
    ...
    leftBottomAlt: "Product shoot visual two",
  },
  concept: {
    label: "DETAIL",
    ...
    videos: [
      {
        ...
        fallbackSrc: "/ceativecontent/GIFanimation2.mp4",
        poster: "/creativeagency/advideo.webp",
        alt: "Product triptych visual one",
      },
      {
        src: "/modernlifestyle/galleryv1.webm",
        fallbackSrc: "/modernlifestyle/designcase1.mp4",
        poster: "/modernlifestyle/mainbanner1.webp",
        alt: "Product triptych visual two",
      },
      {
        src: "/ceativecontent/GIFanimation3.webm",
        fallbackSrc: "/ceativecontent/GIFanimation3.mp4",
        poster: "/creativeagency/photovideoshoot.jpg.webp",
        alt: "Product triptych visual three",
      },
    ],
  },
  quote: {
