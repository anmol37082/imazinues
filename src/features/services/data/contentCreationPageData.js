const contentCreationPageData = {
  ...
  heroImage: {
    src: "/services/ICON-CARDS-4.webp",
    alt: "Content creation service visual",
  },
  video: {
  ...
  context: {
    ...
    leftBottomAlt: "Content planning visual two",
  },
  concept: {
    label: "STORY",
    ...
    videos: [
      {
        ...
        fallbackSrc: "/ceativecontent/GIFanimation3.mp4",
        poster: "/creativeagency/advideo.webp",
        alt: "Content triptych visual one",
      },
      {
        src: "/modernlifestyle/galleryv1.webm",
        fallbackSrc: "/modernlifestyle/designcase1.mp4",
        poster: "/modernlifestyle/mainbanner1.webp",
        alt: "Content triptych visual two",
      },
      {
        ...
        alt: "Content triptych visual three",
      },
    ],
  },
  quote: {
