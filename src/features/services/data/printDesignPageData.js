const printDesignPageData = {
  ...
  heroImage: {
    src: "/services/ICON-CARDS-7.webp",
    alt: "Print design service visual",
  },
  video: {
  ...
  context: {
    ...
    leftBottomAlt: "Print layout visual two",
  },
  concept: {
    label: "MATERIAL",
    ...
    videos: [
      {
        ...
        fallbackSrc: "/ceativecontent/GIFanimation3.mp4",
        poster: "/creativeagency/advideo.webp",
        alt: "Print triptych visual one",
      },
      {
        src: "/modernlifestyle/galleryv1.webm",
        fallbackSrc: "/modernlifestyle/designcase1.mp4",
        poster: "/modernlifestyle/mainbanner1.webp",
        alt: "Print triptych visual two",
      },
      {
        src: "/ceativecontent/GIFanimation1.webm",
        fallbackSrc: "/ceativecontent/GIFanimation1.mp4",
        poster: "/creativeagency/photovideoshoot.jpg.webp",
        alt: "Print triptych visual three",
      },
    ],
  },
  credits: {
