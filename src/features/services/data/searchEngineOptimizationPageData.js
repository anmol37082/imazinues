const searchEngineOptimizationPageData = {
  ...
  heroImage: {
    src: "/services/ICON-CARDS-2.webp",
  ...
  context: {
    ...
    leftBottomAlt: "SEO audit visual two",
  },
  concept: {
    label: "CONTENT",
    ...
    videos: [
      {
        ...
        fallbackSrc: "/ceativecontent/GIFanimation2.mp4",
        poster: "/creativeagency/advideo.webp",
        alt: "SEO triptych visual one",
      },
      {
        src: "/modernlifestyle/galleryv1.webm",
        fallbackSrc: "/modernlifestyle/designcase1.mp4",
        poster: "/modernlifestyle/mainbanner1.webp",
        alt: "SEO triptych visual two",
      },
      {
...
export default searchEngineOptimizationPageData;
