...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <rect x="1.5" y="1.5" width="21" height="21" rx="4.5" fill="#E60019" />
        <path
          fill="#fff"
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              {casesData.map((item) => (
                <li key={item.id}>
                  <span className={styles.linkStatic}>
                    {item.title === "Kiner Kailash Jewellers" ? (
                      <>
                        Kiner Kailash
                        <br />
                        Jewellers
                      </>
                    ) : item.title === "Modern Lifestyle Jewellers" ? (
                      <>
                        Modern Lifestyle
                        <br />
                        Jewellers
                      </>
                    ) : item.title === "Glamour and Radiance" ? (
                      <>
                        Glamour and
                        <br />
                        Radiance
                      </>
                    ) : item.title === "Vetraj Pet Hospital" ? (
                      <>
                        Vetraj Pet
                        <br />
                        Hospital
                      </>
                    ) : item.title === "The Divora" ? (
                      <>
                        The
                        <br />
                        Divora
